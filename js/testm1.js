const questions = [
	{
		question: "Из какго города главный герой мультфильма?",
		answers: [
			"Санта-Тесия.",
			"Санта-Мори.",
			"Санта-Нессия.",
	...
	{
		question: "Кем мечтает стать мигель?",
		answers: [
			"Актёром.",
			"Путешественником.",
			"Музыкантом.",
	...
	{
		question: "На каком инструменте учиться играть Мигель?",
		answers: [
	...
	{
		question: "Почему Имельда (прапрабабушка Мигеля) поставила строжайшее табу на музыку в их семье?",
		answers: [
	...
	{
		question: "Каким ремеслом занималсь вся семья?",
		answers: [
			"Обувным делом.",
			"Шитьё одежды.",
	...
	{
		question: "Как звали кумира Мигеля и музыкальную легенду Санта-Сесилии?",
		answers: [
			"Луис де ла Крус.",
			"Эрнесто де ла Морис.",
			"Антонио де ла Морис",
	...
	{
		question: "В канун какого праздника Мигель решает учавствовать в музыкальном конкурсе?",
		answers: [
			"Пасха.",
			"Новый год.",
			"Страстная пятница.",
	...
	{
		question: "Через что проходят герои мультфильма, чтобы попасть в мир мёртвых?",
		answers: [
	...
	{
		question: "Какое условие ставит Имельда перед благословением Мигеля?",
		answers: [
	...
	{
		question: "Зачем Мигель решает найти Эрнеста де ла Круса?",
		answers: [
	...
	{
		question: "Кого встречает Мигель и просит помочь встретиться с де ла Крусом?",
		answers: [
			"Мануэля.",
			"Габриэля.",
			"Гектора.",
	...
	{
		question: "Как Гектор и Мигель изначально планировали попась к Эрнесту де ла Крусу?",
		answers: [
	...
	{
		question: "Чем Эрнесто де ла Крус так разочаровывает Мигеля?",
		answers: [
	...
	{
		question: "Что Мигель узнаёт о Гекторе, когда охрана выгнала их из дворца и бросила в пещеру?",
		answers: [
	...
	{
		question: "Благодаря кому Мигель и его родственники попадают на концерт Эрнесто де ла Круса?",
		answers: [
			"Фрида Кало.",
			"Теодора Алисия.",
			"Адриана Марисоль.",
