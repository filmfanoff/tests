const questions = [
	...
	{
		question: "На что жаловался Федот Васков до приезда нового отряда? И чем же они ему не угодили...",
		answers: [
	...
	{
		question: "Деушка, с детства живущая в деревне и хорошо отрентирующаяся на местности. Скромная и влюбчивая, но отважная и упёртая.",
		answers: [
			"Женя Комелькова", 
			"Лиза Бричкина", 
			"Рита Осянина", 
	...
	{
		question: "Кто первым доложил старшине Васкову о диверсантах? Она, что есть сил, бежала от немецких солдат обратно в деревню.",
		answers: [
			"Галя Четвертак", 
			"Лиза Бричкина", 
			"Рита Осянина", 
	...
	{
		question: "Про кого были слова 'Не верь ангельскому виду, чёрт в юбке!' А ведь именно она осмелилась отвлечь немецких солдат.",
		answers: [
			"Рита Осянина", 
			"Женя Комелькова", 
			"Соня Гурвич", 
	...
	},
	{
		...
		answers: [
			...
			"Неизвестен уровень вооружённости немецких соладат", 
	...
	{
		question: "Кому старшина Васков доверяет вернуться в деревню за подкрплением? Она ловко пробиралась через болото, лишь бы быстрее, лишь бы успеть...",
		answers: [
			"Женя Комелькова", 
			"Галя Четвертак", 
			"Лиза Бричкина", 
	...
	{
		question: "Что при сметри попросила Рита Осянина у старшины Васкова? Это было её последним желанием.",
		answers: [
